...
public class OPC implements Runnable
{
  ...
  void ledGrid9x9(int index, float x, float y, float spacing, float angle, boolean zigzag, 
    boolean flip)
  {
    ledGrid(index, 9, 9, x, y, spacing, spacing, angle, zigzag, flip);
  }
  
    void ledGrid3x3(int index, float x, float y, float spacing, float angle, boolean zigzag, 
    boolean flip)
  {
    ledGrid(index, 3, 3, x, y, spacing, spacing, angle, zigzag, flip);
  }
